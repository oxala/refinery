...
Refinery::Images.configure do |config|
  ...
  config.user_image_sizes = {:small=>"110x110>", :medium=>"225x255>", :large=>"450x450>", :glebsize=>"200x200>"}
  ...
  # config.dragonfly_secret = "71d89eb5c1674c8dc7c5d6adf519726c9488d95b29067a6c"
  # If you decide to trust file extensions replace :ext below with :format
  # config.dragonfly_url_format = "/system/images/:job/:basename.:ext"
  # config.datastore_root_path = "/localhost/refinery/public/system/refinery/images"
